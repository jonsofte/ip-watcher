...
$ openssl req -newkey rsa:2048 -new -nodes -x509 -days 365 -keyout ip-watcher-key.pem |
    -out ip-watcher-cert.pem -subj "IP-Watcher Service auth"
...
# In the Azure Storage Container, assign the *Role* Role to the application ID, so 
# that it will have the rights to read and write to the container.
# *******
...
# newly created certificate. Enter a password when requested
...
```
The log level of the application. Example: **Information** or **Debug**
